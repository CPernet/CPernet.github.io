...
### [LIMO MEEG](https://limo-eeg-toolbox.github.io/limo_meeg/) `Active`

**LInear MOdelling for M/EEG data**
...
### [SPMup](https://github.com/CPernet/spmup) `Active`
...
### [OpenNeuroPET](https://openneuropet.github.io/) `Active`

**Open PET neuroimaging -- BIDS, tools and pipelines**
...
### [PublicnEUro](https://public-neuro.github.io/) `Platform`

**EU platform for open neuroimaging data**
...
### [Open Brain Consent](https://open-brain-consent.readthedocs.io/en/stable/) `Standard`

**GDPR-compliant consent templates for open neuroimaging**
